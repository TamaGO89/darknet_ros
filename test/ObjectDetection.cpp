...
using CheckForObjectsActionClient = actionlib::SimpleActionClient<darknet_ros::CheckForObjectsAction>;
 ...
 * @param[in] result
 */
void checkForObjectsResultCB(const actionlib::SimpleClientGoalState& state, const darknet_ros::CheckForObjectsResultConstPtr& result) {
...
bool sendImageToYolo(ros::NodeHandle nh, const std::string& pathToTestImage) {
  ...
  // Generate goal.
  darknet_ros::CheckForObjectsGoal goal;
  goal.image = *image;
